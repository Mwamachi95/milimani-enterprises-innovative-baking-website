...
const BackToTop = () => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-10 right-10 md:bottom-12 md:right-12 z-40 w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-luscious-lime hover:bg-wet-sand text-white rounded-2xl shadow-lg transition-all duration-300 flex items-center justify-center group hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-luscious-lime focus:ring-opacity-50 active:scale-95 ${
