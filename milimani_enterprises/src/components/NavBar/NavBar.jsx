...
function NavBar () {
  ...
  return (
    <nav className="sm:pl-15 sm:pr-15 pl-8 pr-8 sticky top-0 z-50 bg-transparent backdrop-blur-sm transition-all duration-1000">
        ...
        >
          ...
          >
            <div className="font-sora">
              <div className="text-[2rem] md:text-[1.5rem] lg:text-md font-semibold text-[#143e45] leading-none">
                Milimani Enterprises
              </div>
              <div className="text-[1.5rem] md:text-[1rem] lg:text-sm font-sm text-[#143e45] leading-none">
                Innovative Baking
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center gap-x-4 md:gap-x-3 lg:gap-x-4">
          ...
          >
            <span className="relative z-10">
              <p className='text-[#143e45] text-lg'>Company</p>
